...
data class LibrarySort(
    ...
    sealed class Type(
        ...
        companion object {
            fun valueOf(flag: Long): Type = types.find { type -> type.flag == flag and type.mask } ?: default.type
        }
    }
    ...
    object Serializer {
        fun deserialize(serialized: String): LibrarySort = LibrarySort.deserialize(serialized)

        fun serialize(value: LibrarySort): String = value.serialize()
    }
