...
sealed interface LibraryDisplayMode {
    ...
    object Serializer {
        fun deserialize(serialized: String): LibraryDisplayMode = LibraryDisplayMode.deserialize(serialized)

        fun serialize(value: LibraryDisplayMode): String = value.serialize()
    }
