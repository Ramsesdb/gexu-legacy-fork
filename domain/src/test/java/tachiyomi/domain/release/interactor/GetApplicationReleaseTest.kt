...
class GetApplicationReleaseTest {
    ...
    @Test
    fun `When has update but is preview expect new update`() =
        runTest {
            ...
            (result as GetApplicationRelease.Result.NewUpdate).release shouldBe
    ...
    @Test
    fun `When has update expect new update`() =
        runTest {
            every { preference.get() } returns 0
            every { preference.set(any()) }.answers { }
    ...
    @Test
    fun `When has no update expect no new update`() =
        runTest {
            every { preference.get() } returns 0
            every { preference.set(any()) }.answers { }
    ...
    @Test
    fun `When now is before three days expect no new update`() =
        runTest {
