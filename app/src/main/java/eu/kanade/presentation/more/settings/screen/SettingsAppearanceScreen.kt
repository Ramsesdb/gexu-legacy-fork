...
object SettingsAppearanceScreen : SearchableSettings {
    ...
    @Composable
    private fun getThemeGroup(uiPreferences: UiPreferences): Preference.PreferenceGroup {
    ...
    @Composable
    private fun getDisplayGroup(uiPreferences: UiPreferences): Preference.PreferenceGroup {
        val context = LocalContext.current
