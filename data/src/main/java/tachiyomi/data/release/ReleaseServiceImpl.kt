...
class ReleaseServiceImpl(
    ...
    override suspend fun latest(arguments: GetApplicationRelease.Arguments): Release? {
        ...
        return Release(
            ...
            info =
                release.info.substringBeforeLast("<!-->").replace(gitHubUsernameMentionRegex) { mention ->
    ...
    private fun getDownloadLink(
        ...
        val map =
            release.assets.associate { asset ->
    ...
    companion object {
         ...
         */
        private val gitHubUsernameMentionRegex =
            """\B@([a-z0-9](?:-(?=[a-z0-9])|[a-z0-9]){0,38}(?<=[a-z0-9]))"""
